...
<div class="container">
    ...
    <div class="centered">
        <a class="cta-button" href="https://dev.beeja.techatcore.com/auth/login/google" style="color: white">Sign in with Google</a>
    </div>
    <p>To get started, please visit: <a href="https://dev.beeja.techatcore.com/">Beeja</a></p>
    <p>If you have any questions or feedback, feel free to contact us!</p>
    <b>We appreciate your help in testing and improving our product!</b>
    <br>
    <p style="color: #6c757d;">Sincerely,</p>
    <p style="color: #6c757d;">The Development Team - Beeja</p>
</div>
</body>
</html>
