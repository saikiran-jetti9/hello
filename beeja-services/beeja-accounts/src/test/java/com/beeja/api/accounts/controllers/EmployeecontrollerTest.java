...
public class EmployeecontrollerTest {
  ...
  public void testCreateEmployee_ValidationError() throws Exception {
    ...
    assertEquals("[First name is mandatory, Last name is mandatory, Email is mandatory, EmployeeID is mandatory]", exception.getMessage());
  }
  ...
  void testGetUsersByEmployeeIds() throws Exception {
    ...
    EmployeeOrgRequest request = new EmployeeOrgRequest();
    ...
    when(employeeService.getUsersByEmployeeIds(anyList())).thenReturn(expectedUsers);
    ...
    assertEquals(expectedUsers, response.getBody(), "The response body should contain the expected user list");
  }
