...
import com.beeja.api.accounts.response.OrganizationFilingAddressResponse;
...
public class OrganizationController {
  ...
  @GetMapping("name/filing-address/{id}")
  public ResponseEntity<?> getOrganizationDetails(@PathVariable("id") String organizationId) {
    OrganizationFilingAddressResponse organizationResponse = organizationService.getOrganizationDetails(organizationId);
