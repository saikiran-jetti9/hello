...
public class HealthInsuranceController {
  ...
  public ResponseEntity<HealthInsurance> submitHealthInsurance(
    ...
    if (bindingResult.hasErrors()) {
      ...
      throw new BadRequestException(BuildErrorMessage.buildErrorMessage(
              ErrorType.VALIDATION_ERROR,
              ErrorCode.FIELD_VALIDATION_MISSING,
              errorMessages.toString()
      ));
    }
      HealthInsurance healthInsurance = healthInsuranceService.saveHealthInsurance(healthInsuranceRequest);
  ...
  public ResponseEntity<HealthInsurance> updateHealthInsurance(
    ...
    HealthInsurance healthInsurance = healthInsuranceService.updateHealthInsurance(healthInsuranceRequest, employeeID);
    return new ResponseEntity<>(healthInsurance, HttpStatus.OK);
  }

  @DeleteMapping("/employee/{employeeID}")
  @HasPermission(DELETE_HEALTH_INSURANCE)
  public ResponseEntity<HealthInsurance> deleteHealthInsurance(@PathVariable String employeeID) throws Exception {
      HealthInsurance healthInsurance = healthInsuranceService.deleteByEmployeeIdAndOrganizationId(employeeID);
      return new ResponseEntity<>(healthInsurance, HttpStatus.OK);
  }

  @GetMapping("/employee/{employeeID}")
  @HasPermission(READ_HEALTH_INSURANCE)
  public ResponseEntity<HealthInsurance> getHealthInsuranceByEmployeeId(@PathVariable String employeeID) throws Exception {
