...
public class InventoryController {
  ...
  public ResponseEntity<InventoryResponseDTO> filterInventory(
    ...
    List<Inventory> devices = inventoryService.filterInventory(pageNumber, pageSize, device, provider, availability, os);
  ...
  public ResponseEntity<Inventory> updateDeviceDetails(
      @Valid @RequestBody DeviceDetails deviceDetails, @PathVariable String deviceId)
      throws Exception {
