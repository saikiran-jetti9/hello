    ...
    try {
      ...
      throw new Exception(
              BuildErrorMessage.buildErrorMessage(
                      ...
                      Constants.ERROR_UPDATING_HEALTH_INSURANCE + Constants.APPEND_EXCEPTION_MESSAGE + e.getMessage()
              )
      );
    }
  }
    ...
    try {
      ...
      throw new RuntimeException(
              BuildErrorMessage.buildErrorMessage(
                      ...
                      Constants.ERROR_FETCHING_HEALTH_INSURANCE + Constants.APPEND_EXCEPTION_MESSAGE + e.getMessage()
              )
      );
    }
  }
