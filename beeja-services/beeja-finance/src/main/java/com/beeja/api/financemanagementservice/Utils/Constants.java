...
public class Constants {
  ...
  public static final String ERROR_FETCHING_DEVICE_DETAILS = "Error While Fetching Details of Devices";
  public static final String ERROR_DELETING_DEVICE_DETAILS = "Error While Deleting the Device Details";
