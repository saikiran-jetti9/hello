  ...
  return (
    <Container>
      <span className="roleInfo">
        <InfoCircleSVG />
        <span>
          The Read permission is base permission for all modules. For example,
          in the Documents module, you need the Read permission to view
          documents, even if you have the update permission.
        </span>
      </span>
